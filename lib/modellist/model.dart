List quotesapplist=[
  {
   ...
   "life":[
      ...
      {
         "quote":"Do not set out in life to be an interesting person. Set out to be an interested person.",
   ...
   "success":[
      ...
      {
         "quote":"It's funny how many years it takes to become an overnight success.",
         "author":"Prince"
      }
   ],
   "motivational":[
      ...
      {
         "quote":"Behind the honor of the people who have come before me and those who will come after me, mediocrity will find no place within me.",
         "author":"Based on The Wheel of Time by Robert Jordan"
      }
   ],
   "fun":[
      {
   ...
   "failure":[
      {
         "quote":"Failure is an opportunity to begin again, this time more intelligently.",
         "author":"Henry Ford"
      },
      {
      ...
      {
         "quote":"To stumble twice against the same stone is a proverbial disgrace.",
         "author":"Cicero"
      },
      {
      ...
      {
         "quote":"People don't mature with age,people mature with damage",
         "author":"Unknown"
      },
      {
   ...
   "gaming":[
      {
         "quote":"A game is the complete exploration of freedom within a restrictive environment.",
         "author":"Vineet Raj Kapoor"
      },
      {
         "quote":"Games were not just a diversion, I realized. Games could make you feel.",
         "author":"Sid Meier"
      },
      {
         "quote":"In summers, after 1 hour of extreme gaming you can use your laptop to iron your shirt.",
         "author":"Neetesh Dixit"
      },
      {
         "quote":"For a game, you don't need a teacher.",
         "author":"Deja"
      },
      {
         "quote":"Gamers have so much freedom. you can go anywhere you want.",
         "author":"Jenova Chen"
      }
   ],
   "birthday":[
      ...
      {
         "quote":"You don't get older, you get better.",
   ...
   "Humorous":[
      ...
      {
         "quote":"To get back my youth I would do anything in the world, except take exercise, get up early, or be respectable.",
         "author":"Oscar Wilde"
      },
      {
